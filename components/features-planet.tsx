      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            ...
            Easy Laundry allows you to worry less about your clothing. 
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span className="text-black font-bold">Location Selection </span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Easily choose your preferred location, whether it’s your home or workplace. This feature ensures that you can manage your laundry needs based on your lifestyle and convenience.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span className="text-black font-bold">Seamless QR Payment </span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Experience hassle-free transactions with our seamless QR payment system. This innovative feature enables shippers to effortlessly pick up and deliver your laundry directly to your specified location.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span className="text-black font-bold">Machine Availability </span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Stay informed with real-time updates on machine availability. Our platform allows you to see which machines are free or occupied, ensuring you can efficiently plan your laundry tasks.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span className="text-black font-bold">Wash Type Selection </span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Customize your laundry experience by selecting your preferred wash type. Whether you need a gentle cycle for delicate fabrics or a powerful wash for tough stains, we’ve got you covered.
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span className="text-black font-bold">Softener Type Choice</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Enhance your laundry with your choice of fabric softener. Our app allows you to select the softener that best suits your preferences, ensuring your clothes come out feeling fresh and soft.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span className="text-black font-bold">Order Progress Tracking</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Monitor the status of your laundry order with our intuitive progress wheel. This feature keeps you informed at every stage of the process, providing peace of mind as you wait for your laundry to be completed.
              </p>
            </article>
          </div>
        </div>
